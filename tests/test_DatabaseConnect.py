...
class TestDatabaseConnect(unittest.TestCase):
    ...
    def test_connect(self) :
        ...
        with Connection.ClutterBaseConnection(f"{self.dir_name.name}/connect_test.db") as connection :
    ...
    def test_add_item(self) :
        ...
        with Connection.ClutterBaseConnection("connect_test.db") as connection :
            self.assertTrue(connection !=None)
            connection.add_item("Whisk","A whisk","testdata/Whisk/whisk.obj",
            "testdata/Whisk/WhiskTop.png","testdata/Whisk/WhiskPersp.png","testdata/Whisk/WhiskSide.png","testdata/Whisk/WhiskFront.png")
